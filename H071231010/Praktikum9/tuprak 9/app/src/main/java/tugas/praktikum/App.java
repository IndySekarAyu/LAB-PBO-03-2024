...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Image imageIcon = new Image(getClass().getClassLoader().getResourceAsStream("logo.png"));
        if (imageIcon == null) {
    ...
    private Scene registerScene(Stage stage) {
        ...
        Pane root = new Pane();
        root.getChildren().addAll(registerLabel, nama1, nama2, dateField, dateLabel, usernama1, usernama2,
