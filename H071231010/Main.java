...
public class Main {
    ...
    private static Karyawan tambahDataKaryawan(Scanner scanner, Organisasi organisasi, Keluarga keluarga) {
        ...
        if (pendidikanTerakhir.equalsIgnoreCase("SD") || pendidikanTerakhir.equalsIgnoreCase("SMP") || karyawan.getUmur() < 18 || pendidikanLulus(karyawan.getUmur()) || karyawan.getUmur() > 30 || organisasi.getJenisOrganisasi().equalsIgnoreCase("Tidak ada")) {
